...
class Config:
    ...
    AZURE_ENTRAID_SCOPE = os.getenv("AZURE_ENTRAID_SCOPE")
    AZURE_ENTRAID_ACCESSTOKEN_ISSUER= os.getenv("AZURE_ENTRAID_ACCESSTOKEN_ISSUER")
    AZURE_ENTRAID_IDTOKEN_ISSUER= os.getenv("AZURE_ENTRAID_IDTOKEN_ISSUER")
